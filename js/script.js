const global = {
  ...
  api: {
    ...
    apiKey: '98fb5a79fd8db0d1e3c3b68ad433c690',
...
async function displayShowDetails() {
  ...
  div.innerHTML = `
    ...
    <div>
      ...
      <p class="text-muted">Last Air Date: <span>${show.last_air_date}</span></p>
      <p>
      ${show.overview}
      </p>
      <h5>Genres</h5>
      <ul class="list-group">
        <li>${show.genres.map((genre) => `<li>${genre.name}</li>`).join('')}</li>
      </ul>
    ...
    <div class="details-bottom">
      <h2>Show Info</h2>
      <ul>
        <li><span class="text-secondary">Number of Shows:</span> ${show.number_of_episodes}</li>
...
function displayPagination() {
  ...
  // Next Event Listeners to Pagination Buttons
  ...
  // Prev Event Listeners to Pagination Buttons
